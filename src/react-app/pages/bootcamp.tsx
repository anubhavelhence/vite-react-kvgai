                ...
                >
                    <div className="mx-auto flex max-w-4xl items-center justify-between gap-4">
                        <div className="hidden sm:block">
                            <p className="text-sm font-bold text-white">Next-Gen AI Protocols Bootcamp — 26th Feb, 6–8 PM, BITS Pilani</p>
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const options: RazorpayOptions = {
                ...
                description: "Next-Gen AI Protocols Bootcamp — 26 Feb, 6–8 PM, BITS Pilani",
                ...
                <div className="mx-auto max-w-lg px-6 md:px-8">
                    <FadeIn>
                        <div className="rounded-2xl border border-emerald-500/20 bg-white/[0.02] p-8 text-center md:p-12">
                                ...
                                <p className="mt-3 text-gray-400">You're registered for the Next-Gen AI Protocols Bootcamp — 26th Feb, 6–8 PM, Room 6109, NAB, BITS Pilani.</p>
    ...
    <footer className="border-t border-white/10 bg-[#0c0c14] pt-10 pb-32 md:pb-24">
        <div className="mx-auto max-w-4xl px-6 md:px-8">
            ...
            <div className="mt-6 text-center">
                ...
                <p className="mt-1 text-xs text-gray-400">GSTIN: 29AALCK3280A1ZL</p>
