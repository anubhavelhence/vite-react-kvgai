            ...
            <div className="mx-auto max-w-container px-4 md:px-8">
                <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
                    ...
                    <p className="mt-4 text-lg text-tertiary md:mt-6 md:text-xl">
                        At KVGAITech, we go beyond superficial GenAI. We design deep, knowledge-driven AI systems that are fast, cost-efficient, and production-ready. Our focus is on solving real enterprise problems with scalable architectures, autonomous agent orchestration, and structured knowledge systems—not just LLM wrappers.
                    </p>
                </div>
            </div>
        </section>
