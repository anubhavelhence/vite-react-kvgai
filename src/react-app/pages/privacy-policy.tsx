                    ...
                    <div className="mx-auto max-w-3xl">
                        <div className="rounded-2xl bg-brand-secondary/10 p-6 ring-1 ring-brand-secondary/20 ring-inset md:p-8">
                            <p className="text-base text-tertiary md:text-lg">
                                LandMarks ("we", "our", or "us") is operated by <span className="font-semibold text-primary">KVGAI TECH PRIVATE LIMITED</span>. We respect your privacy and are committed to protecting the personal information of our users.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid gap-6 sm:grid-cols-2 md:gap-8">
                            ...
                            <div className="rounded-2xl bg-secondary p-6 ring-1 ring-secondary ring-inset">
                                ...
                                <p className="text-sm text-tertiary">
                                    LandMarks is intended for users aged <span className="font-semibold text-primary">13 years and above</span>. We do not knowingly collect data from children under 13.
                                </p>
                            </div>
                        </div>
